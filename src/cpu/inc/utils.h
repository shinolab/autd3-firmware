...
inline static void memcpy_volatile(volatile void *restrict dst,
...
inline static void memset_volatile(volatile void *restrict dst, const int value,
                                   uint32_t cnt) {
...
inline static void word_cpy_volatile(volatile uint16_t *dst,
                                     volatile const uint16_t *src,
                                     uint32_t cnt) {
  while (cnt-- > 0) *dst++ = *src++;
}
