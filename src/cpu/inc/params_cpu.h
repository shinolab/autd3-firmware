...
#define TAG_CONFIG_PULSE_WIDTH_ENCODER (0x72)
#define TAG_PHASE_CORRECTION (0x80)
#define TAG_OUTPUT_MASK (0x90)
...
#define NO_ERR (0x00)
#define ERR_NOT_SUPPORTED_TAG (0x01)
#define ERR_INVALID_MSG_ID (0x02)
#define ERR_INVALID_INFO_TYPE (0x03)
#define ERR_INVALID_GAIN_STM_MODE (0x04)
#define ERR_INVALID_SEGMENT_TRANSITION (0x05)
#define ERR_MISS_TRANSITION_TIME (0x06)
#define ERR_INVALID_SILENCER_SETTING (0x07)
#define ERR_INVALID_TRANSITION_MODE (0x08)
