...
#define SILENCER_FLAG_BIT_PULSE_WIDTH (1)
#define SILENCER_FLAG_PULSE_WIDTH (1 << SILENCER_FLAG_BIT_PULSE_WIDTH)
...
#define ADDR_MOD_FREQ_DIV0 (0x23)
#define ADDR_MOD_REP0 (0x24)
#define ADDR_MOD_CYCLE1 (0x25)
#define ADDR_MOD_FREQ_DIV1 (0x26)
#define ADDR_MOD_REP1 (0x27)
#define ADDR_MOD_TRANSITION_MODE (0x28)
#define ADDR_MOD_TRANSITION_VALUE_0 (0x29)
#define ADDR_MOD_TRANSITION_VALUE_1 (0x2A)
#define ADDR_MOD_TRANSITION_VALUE_2 (0x2B)
#define ADDR_MOD_TRANSITION_VALUE_3 (0x2C)
...
#define ADDR_STM_FREQ_DIV0 (0x54)
#define ADDR_STM_REP0 (0x55)
#define ADDR_STM_MODE0 (0x56)
#define ADDR_STM_SOUND_SPEED0 (0x57)
#define ADDR_STM_NUM_FOCI0 (0x58)
#define ADDR_STM_CYCLE1 (0x59)
#define ADDR_STM_FREQ_DIV1 (0x5A)
#define ADDR_STM_REP1 (0x5B)
#define ADDR_STM_MODE1 (0x5C)
#define ADDR_STM_SOUND_SPEED1 (0x5D)
...
#define ADDR_DEBUG_VALUE0_0 (0xF1)
#define ADDR_DEBUG_VALUE0_1 (0xF2)
#define ADDR_DEBUG_VALUE0_2 (0xF3)
#define ADDR_DEBUG_TYPE1 (0xF4)
#define ADDR_DEBUG_VALUE1_0 (0xF5)
#define ADDR_DEBUG_VALUE1_1 (0xF6)
#define ADDR_DEBUG_VALUE1_2 (0xF7)
#define ADDR_DEBUG_TYPE2 (0xF8)
#define ADDR_DEBUG_VALUE2_0 (0xF9)
#define ADDR_DEBUG_VALUE2_1 (0xFA)
#define ADDR_DEBUG_VALUE2_2 (0xFB)
#define ADDR_DEBUG_TYPE3 (0xFC)
#define ADDR_DEBUG_VALUE3_0 (0xFD)
#define ADDR_DEBUG_VALUE3_1 (0xFE)
#define ADDR_DEBUG_VALUE3_2 (0xFF)
