...
#define BRAM_ADDR_MOD_REP_0 (0x28)
#define BRAM_ADDR_MOD_REP_1 (0x29)
...
#define BRAM_ADDR_STM_MODE (0x53)
...
#define BRAM_ADDR_STM_REP_0 (0x5A)
#define BRAM_ADDR_STM_REP_1 (0x5B)
#define BRAM_ADDR_STM_SOUND_SPEED_0 (0x5C)
#define BRAM_ADDR_STM_SOUND_SPEED_1 (0x5D)
#define BRAM_ADDR_PULSE_WIDTH_ENCODER_TABLE_WR_PAGE (0x60)
#define BRAM_ADDR_PULSE_WIDTH_ENCODER_FULL_WIDTH_START (0x61)
#define BRAM_ADDR_DEBUG_OUT_IDX (0xF0)

#define CTL_FLAG_FORCE_FAN_BIT (13)
#define CTL_FLAG_SET_BIT (14)
#define CTL_FLAG_SYNC_BIT (15)

#define CTL_FLAG_FORCE_FAN (1 << CTL_FLAG_FORCE_FAN_BIT)
#define CTL_FLAG_SET (1 << CTL_FLAG_SET_BIT)
...
#define SILNCER_FLAG_MODE (0x01)
#define SILNCER_FLAG_STRICT_MODE (0x80)
...
#define TAG_STM_CHANGE_SEGMENT (0x42)
...
#define NO_ERR (0x00)
#define REQ_UPDATE_SETTINGS (0x01)
