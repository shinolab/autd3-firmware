...
uint8_t clear(void) {
  ...
  bram_write(BRAM_SELECT_CONTROLLER, BRAM_ADDR_SILENCER_MODE, SILNCER_MODE_FIXED_COMPLETION_STEPS);
  ...
  bram_cpy(BRAM_SELECT_CONTROLLER, BRAM_ADDR_MOD_FREQ_DIV_0_0, (uint16_t*)&_mod_freq_div, sizeof(uint32_t) >> 1);
  bram_write(BRAM_SELECT_CONTROLLER, BRAM_ADDR_MOD_CYCLE_1, _mod_cycle - 1);
  bram_cpy(BRAM_SELECT_CONTROLLER, BRAM_ADDR_MOD_FREQ_DIV_1_0, (uint16_t*)&_mod_freq_div, sizeof(uint32_t) >> 1);
  ...
  bram_write(BRAM_SELECT_CONTROLLER, BRAM_ADDR_DEBUG_TYPE_0, 0);
  bram_write(BRAM_SELECT_CONTROLLER, BRAM_ADDR_DEBUG_TYPE_1, 0);
  bram_write(BRAM_SELECT_CONTROLLER, BRAM_ADDR_DEBUG_TYPE_2, 0);
  bram_write(BRAM_SELECT_CONTROLLER, BRAM_ADDR_DEBUG_TYPE_3, 0);
